...
<style>
	...
	@media (min-width:961px)  { .views{ object-fit: cover;width: 100%;height: 200px; } /* tablet, landscape iPad, lo-res laptops ands desktops */ }
	@media (min-width:1025px) { .views{ object-fit: cover;width: 100%;height: 200px;} /* big landscape tablets, laptops, and desktops */ }
	@media (min-width:1281px) { .views{ object-fit: cover;width: 100%;height: 200px;} /* hi-res laptops and desktops */ }
</style>
